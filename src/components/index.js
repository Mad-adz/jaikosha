...
export const SubscribeBtn = lazy(() => import("./SubscribeBtn"));
export const HamburgerMenu = lazy(() => import("./HamburgerMenu"));
export const PanoramicBanner = lazy(() => import("./PanoramicBanner"));

export const ResourceCard = lazy(() => import("./home/ResourceCard"));
export const EventCard = lazy(() => import("./home/EventCard"));
