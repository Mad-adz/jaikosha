      ...
      <div className="container">
        ...
        {/* <div className="text-center mt-10">
          <p className="text-lg text-gray-600 mb-6">
            Engage in meaningful discussions and share your experiences with
            others.
          </p>
          <a
            href="#"
            className="inline-block bg-emerald-500 text-white px-6 py-3 rounded-lg text-lg font-medium hover:bg-emerald-600 transition"
          >
            {" "}
            Join the Discussion{" "}
          </a>
